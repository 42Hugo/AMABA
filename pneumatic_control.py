...
class Pneumatic:
    ...
    def start_connection(self):                
        ...
        try:
            os.system('sudo ethercatctl start')#start the ethercat master
            time.sleep(0.2)
        except:
            print("when tryin to start the ethercat master")
        try:
    ...
    def stop_c_program(self):
        ...
        self.process.wait()
        self.client.close()  
        os.system('sudo ethercatctl stop')#stop the ethercat master
